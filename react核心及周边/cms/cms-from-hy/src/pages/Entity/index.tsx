...
export default function () {
  const [{ current, pageSize }, setPageConfig] = useState({
    current: 1,
    pageSize: 10,
  });
      ...
      render(_, row) {
        return (
          <Space>
            ...
            <Button type="primary" onClick={() => deleteRecords([row])}>
              删除
            </Button>
          </Space>
        );
      ...
      <Row>
        <Col xs={24} style={{ textAlign: 'right', padding: '10px' }}>
          <Space>
            ...
            />
            <Button type="primary" onClick={() => history.push('/entity/edit')}>
              添加
            </Button>
          </Space>
        </Col>
        ...
        <Col xs={24} style={{ textAlign: 'right', padding: '10px' }}>
          <Pagination
            ...
            onChange={(current, pageSize) =>
              setPageConfig({ current, pageSize })
            }
          />
        </Col>
      </Row>
